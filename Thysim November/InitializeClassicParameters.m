function InitializeClassicParameters(BW,Ht,Age,gender,Hct,bg,LBMcal_option,Dosecal_option)
%Initializes various parameters as globals
global LBM Vp BV Ot VpR OtR kOP kPO
%% LBM and Dose cal
BW0 = 72;% original BW
Ht0 = 178;% original Ht
Hct0 = 0.4;
...
y0(20) = p(13);
u1 = dose/777/24;                     % Infusion into plasma T4
